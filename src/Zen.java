 ...
 * 
 * This code is copyright but free to use. It is provided under 
 * the "Attribution Creative Commons License"
 ...
 * copyright information about your program. 
...
public class Zen extends JApplet {
	...
	public static void drawRect(int x1, int y1, int width, int height) {
			getInstanceFromThread().drawRect(x1, y1, width, height);
	}
	...
	class ZenInstance {
		...
		public void drawRect(int x1, int y1, int width, int height) {
			getBufferGraphics().drawRect(x1, y1, width, height);
			if (paintImmediately)
				paintWindowImmediately();
		}
